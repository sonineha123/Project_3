...
.grad{
background-image: linear-gradient(to bottom right,pink,skyblue,white,pink);
...
.p4 {
	background-image: url('<%=ORSView.APP_CONTEXT%>/img/teahu.jpg');
	background-size: cover;
	background-repeat:no repeat;
						...
						<div class="card-body">
								...
								<div class="input-group">
									<div class="input-group-prepend">
										<div class="input-group-text">
											<i class="fa fa-envelope white-text" style="font-size: 1rem;"></i>
										</div>
							...
							<div class="col-sm-12">
								<div class="input-group">
									<div class="input-group-prepend">
										<div class="input-group-text">
											<i class="fa fa-lock white-text" style="font-size: 1rem;"></i>
										</div>
									</div>
							...
							<div class="text-center">
								<a href="<%=ORSView.FORGET_PASSWORD_CTL%>"
									style="color: cyan; font-size: 15px;"><b>Forget my
										password ?</b></a>
							</div>
